...
def init():
    ...
    try:
        ...
        # In Azure ML, models are mounted in the directory '/var/azureml-app/azureml-models/'
        # Try different possible model paths
        possible_model_paths = [
            Model.get_model_path('best_churn_model'),  # Azure ML registered model
            './models/Best_Churn_Model.pkl',           # Local development
        ...
        if not model_loaded:
            # If no model file found, check if we're in a test environment
            # and create a mock model for testing purposes
...
if __name__ == "__main__":
    ...
    # Test cases
    test_cases = [
        {"features": [10, 5, 200]},    # Good customer - should predict No Churn
        {"features": [120, 1, 50]},    # High recency - should predict Churn
        {"features": [60, 3, 150]},    # Medium case
        {"features": [30, 10, 500]},   # Excellent customer
        {"features": [150, 2, 75]}     # Very high recency
    ]
